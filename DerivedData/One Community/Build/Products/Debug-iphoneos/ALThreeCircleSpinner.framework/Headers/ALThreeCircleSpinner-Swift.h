...
SWIFT_CLASS("_TtC20ALThreeCircleSpinner20ALThreeCircleSpinner")
@interface ALThreeCircleSpinner : UIView
...
/// <ul><li><p>Start animating the loader view</p></li></ul>
- (void)startAnimating;

/// <ul><li><p>Stop animating the loader view</p></li><li><p>if hidesWhenStopped = true then the loader will be hidden as well</p></li></ul>
- (void)stopAnimating;

/// <ul><li><p>returns true if the loader is animating</p></li></ul>
- (BOOL)isAnimating;
@end
